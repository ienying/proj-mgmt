...
CREATE TABLE IF NOT EXISTS projects (
  ...
  module_quantities JSONB DEFAULT '{}'::jsonb,
  ...
  construction_units_info JSONB DEFAULT '[]'::jsonb,
...
CREATE TABLE IF NOT EXISTS data_table_definitions (
  ...
  gantt_enabled BOOLEAN DEFAULT false,
  gantt_start_col VARCHAR(100),
  gantt_end_col VARCHAR(100),
  gantt_name_col VARCHAR(100),
  gantt_group_col VARCHAR(100),
  gantt_milestone_col VARCHAR(100),
  gantt_milestone_value VARCHAR(200),
  sort_order INTEGER DEFAULT 0 NOT NULL,
  is_active BOOLEAN DEFAULT true NOT NULL,

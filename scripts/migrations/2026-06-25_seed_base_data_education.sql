...
('qidong',     '启动',    '项目立项、组建团队、明确目标与范围',           0, true),
('diaoyan',    '调研',    '深入调研客户需求，确认技术方案与实施计划',     1, true),
('bushu',      '部署',    '硬件环境准备、基础平台部署与联调',             2, true),
('kaifa',      '开发',    '核心功能开发、第三方系统集成对接',             3, true),
('shiyun',     '试运行',  '用户培训、UAT测试、试运行问题修复',            4, true),
('shangxian',  '上线',    '生产环境上线、数据迁移、业务全面切换',         5, true),
('yanshou',    '验收',    '竣工验收、文档交付、项目总结',                 6, true)
ON CONFLICT (code) DO NOTHING;
...
-- 6. 施工单位（教育行业相关）
-- ============================================
INSERT INTO construction_units (code, name, contact_person, phone, cooperation_level, quality_rating, description, sort_order, is_enabled) VALUES
('edu_tech_a',          '北京教育科技建设有限公司',     '张建国',   '13801001234',   'A级',   '优秀',   '专注高校信息化建设，智慧校园整体方案',         0, true),
('smart_edu_build',     '上海智慧教育建设有限公司',     '李明华',   '13901002345',   'A级',   '优秀',   'K12智慧校园、一卡通系统建设',                   1, true),
('south_edu_constr',    '广州南方教育建设有限公司',     '王志强',   '13701003456',   'A级',   '良好',   '教育实验室、实训基地建设',                     2, true),
('huadong_network',     '华东教育网络科技有限公司',     '陈小芳',   '13601004567',   'B级',   '良好',   '校园网络、数据中心基础设施建设',               3, true),
('zhongke_edu',         '中科教信息技术有限公司',       '赵伟东',   '13501005678',   'B级',   '一般',   '教育信息化、教学资源平台建设',                 4, true),
('huizhong_edu',        '汇众教育装备有限公司',         '刘建国',   '13301006789',   'C级',   '一般',   '实验室设备安装、多媒体教室建设',               5, true)
ON CONFLICT (code) DO NOTHING;

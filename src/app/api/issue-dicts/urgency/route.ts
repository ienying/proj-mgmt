...
// GET /api/issue-dicts/urgency
export async function GET() {
  try {
    const client = await createServerClient();
    const { data, error } = await client.rpc("dp_select", {
      p_table: "issue_mgmt_issue_urgency",
    });
    if (error) {
...
// PUT /api/issue-dicts/urgency?id=xxx
...
// DELETE /api/issue-dicts/urgency?id=xxx

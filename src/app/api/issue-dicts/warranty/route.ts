...
// GET /api/issue-dicts/warranty
export async function GET() {
  try {
    const client = await createServerClient();
    const { data, error } = await client.rpc("dp_select", {
      p_table: "issue_mgmt_issue_warranty_status",
    });
    if (error) {
...
// PUT /api/issue-dicts/warranty?id=xxx
...
// DELETE /api/issue-dicts/warranty?id=xxx

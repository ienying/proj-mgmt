...
export function WeeklyReportForm({ customerId, customerName, currentUser, onClose, embedded }: WeeklyReportFormProps) {
      ...
      {showForm && (
        <div className="mt-4 space-y-4 border rounded-lg p-4 bg-muted/10">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5"><Label className="text-xs">巡检时间</Label><Input className="h-8 text-xs" value={inspectionTime} onChange={(e) => setInspectionTime(e.target.value)} /></div>
            <div className="space-y-1.5"><Label className="text-xs">巡检范围</Label><Input className="h-8 text-xs" value={inspectionScope} onChange={(e) => setInspectionScope(e.target.value)} /></div>
            <div className="space-y-1.5"><Label className="text-xs">隐患情况</Label><Input className="h-8 text-xs" value={inspectionIssues} onChange={(e) => setInspectionIssues(e.target.value)} /></div>
            <div className="space-y-1.5">

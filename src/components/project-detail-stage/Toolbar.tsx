    ...
    >
      <div className="flex items-center gap-0" style={{ minWidth: "430px" }}>
        ...
        <button onClick={onSwitchLayout}
          className="flex items-center gap-1.5 px-3 h-[38px] cursor-pointer whitespace-nowrap text-xs font-medium tracking-[0.3px] transition-all border border-[var(--s-orange)] text-[var(--s-orange)] bg-[var(--s-surface)] hover:bg-[rgba(232,89,12,.06)] flex-shrink-0">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

...
export const phaseDetails: Record<string, PhaseDetailData> = {
  ...
  phase1: {
    ...
    statusClass: "done",
    name: "需求调研与方案确认",
    description: "实地调研、软硬件环境勘察和梳理科室原有业务流程，重点组织校方召开实施启动会，统一确认需求边界，明确项目实施范围边界。",
  ...
  phase2: {
    ...
    statusClass: "done",
    name: "环境部署与平台搭建",
    description: "完成环境部署与平台搭建工作，完成硬件设备现场安装调测、整套软件平台部署搭建及各模块功能调试，同步对接外部系统完成接口联调，保障软硬件稳定协同运行。",
  ...
  phase3: {
    ...
    statusClass: "active",
    name: "用户培训与试运行",
    description: "组织学校管理员、教师、学生及家长的分批培训，系统进入试运行阶段，收集反馈意见，持续优化功能和用户体验。",
  ...
  phase4: {
    ...
    statusClass: "pending",
    name: "项目验收与交付",
    description: "汇总全部阶段输出文档，编制验收文档包。组织验收评审会，完成系统演示、评审验收和正式交付确认。",
    dateRange: "2026.08.16 — 2026.10.15",
    metaItems: [
      { value: "12", label: "交付物" },
      { value: "46天", label: "周期" },
